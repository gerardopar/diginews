...
class LifeNewsPage extends React.Component {
    ...
    async componentDidMount(){
        ...
        const response = await fetch(`https://newsapi.org/v2/top-headlines?sources=time&apiKey=797ecd01a4354164974ef9414a36199d`);
        ...
        if(response.status === 200){
            ...
            throw new Error('unable to fetch life news');
        }
    }
